 ...
 * But Username + Password is also supported by this class. A WinterUser can
 ...
 *
 */
public class WinterUser implements UserDetails {
    ...
    public WinterUser(int userId, String username, String password,
    ...
    public WinterUser(String openId, Collection<? extends GrantedAuthority> authorities, 
    ...
    public WinterUser(String username, String password,
...
//        SortedSet<GrantedAuthority> sortedAuthorities = new TreeSet<GrantedAuthority>();
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        WinterUser other = (WinterUser) obj;
        if (username == null) {
